...
async def trigger_job_search(
    ...
    """Search multiple job boards (RemoteOK, Arbeitnow, The Muse, Adzuna).

    Uses only official public APIs — no scraping, no ToS violations.
    Results are scored with the confidence algorithm and added to your daily batch.
    """
